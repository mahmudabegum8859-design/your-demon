...
public class HandshakeStorage extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // This is checking if there are any files in the `/storage/emulated/0/YourDemon/captured`
        ...
        if (!core.getListFiles(new File("/storage/emulated/0/YourDemon/captured")).isEmpty()) {
            HandshakesAdapter mAdapter = new HandshakesAdapter(context, activity, core.getListFiles(new File("/storage/emulated/0/YourDemon/captured")));
