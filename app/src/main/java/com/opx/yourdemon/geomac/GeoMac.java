package com.opx.yourdemon.geomac;
...
import com.opx.yourdemon.geomac.utils.GetGeoByMac;
...
public class GeoMac extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fixinet();
        try {
            if (!CheckFile.check("/data/local/YourDemon/release/modules/GeoMac/geomac")) {
        ...
        search.setOnClickListener(view1 -> {
            ...
            new Thread(() -> {
                ...
                try {
                    ...
                    String coords = GetGeoByMac.execute(q, core);
